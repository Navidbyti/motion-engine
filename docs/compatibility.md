...
| After Effects point/paragraph text, rectangle, linked image, linear position keys, and `zIndex` layer order | Experimental JSX exporter; save/reopen passed on Windows with After Effects 2024 24.5x52 for ten public fixtures across the stated subsets |
