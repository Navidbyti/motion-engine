...
| After Effects point/paragraph text, rectangle, linked image, sampled easing for opacity/position, and `zIndex` layer order | Experimental JSX exporter; save/reopen passed on Windows with After Effects 2024 24.5x52, including horizontal and vertical animated director plans |
