...
| Premiere Pro 2026 26.5.1 | The plugin-free Final Cut Pro 7 XML subset passed native import on Windows on 2026-09-20. Premiere created a 4-second, 30 fps, 270×480 sequence with two contiguous clips and two named beat markers. The linked H.264 media was online. The project saved as `.prproj` and reopened at the same path. A native H.264 export contained 120 frames; sampled frames at 0, 30, 60, 90, and 119 matched the source within re-encoding differences. This proves the silent, cut-only fixture, not audio, graphic editability in Premiere, or other sequence profiles. UXP remains optional and untested. |
