...
| Premiere Pro 2026 26.5.1 | Installed on the Windows development host. A Final Cut Pro 7 XML exporter from verified previews passes structural and integrity tests; native import is pending. An optional UXP scratch-project probe exists but was not run. No sequence/export compatibility claim yet. |
