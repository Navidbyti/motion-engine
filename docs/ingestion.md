...
Parsers never fetch external links, execute macros, or rewrite the source. They can be registered by extension through `register_parser`. Richer layout evidence, OCR, waveform/word timing, and visual extraction remain later work.
