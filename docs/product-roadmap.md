...
- [x] Prove an initial editable After Effects text subset on two public fixtures with app-level save/reopen checks; other primitives and automated execution remain.
