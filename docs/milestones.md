...
| M2, deterministic rendering (in progress) | Text, rectangles, bar/line charts, keyframes, data binding, silent FFmpeg preview are implemented; transitions, broader primitives, audio, and visual QA remain | Public fixtures render at exact frame counts; values match sources; unsupported content fails explicitly |
